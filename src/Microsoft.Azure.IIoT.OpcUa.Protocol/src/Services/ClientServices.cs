...
namespace Microsoft.Azure.IIoT.OpcUa.Protocol.Services
{
        ...
        IDisposable
    {
        ...
        public ClientServices(ILogger logger, TimeSpan? maxOpTimeout = null)
        {
            ...
            var app = new ApplicationInstance(_config);
            bool haveAppCertificate = app.CheckApplicationInstanceCertificate(false, CertificateFactory.defaultKeySize, CertificateFactory.defaultLifeTime).Result;
            if (!haveAppCertificate)
            {
                throw new Exception("Application instance certificate invalid!");
            }
            Certificate = app.ApplicationConfiguration.SecurityConfiguration.ApplicationCertificate.Certificate;
            ...
            TimeSpan operationTimeout, TimeSpan sessionTimeout)
        {
            ...
            {
                ApplicationName = "Azure IIoT Service Client",
                ApplicationType = Opc.Ua.ApplicationType.Client,
                ApplicationUri = "urn:" + Utils.GetHostName() + ":OPCFoundation:AzureIIotClient",
                SecurityConfiguration = new SecurityConfiguration
                {
                    ApplicationCertificate = new CertificateIdentifier
                    {
                        ...
                        SubjectName = "CN=Azure IIoT Service Client"
                    },
            ...
            appConfig.CertificateValidator.Update(appConfig.SecurityConfiguration);
            return appConfig;
        }
