...
namespace Microsoft.Azure.IIoT.OpcUa.Vault.Utils {
    ...
    public static class Serialization {
        ...
        private static readonly JsonSerializerSettings kSerializationSettings =
        ...
        public static string Serialize(object o) {
            ...
            foreach (var data in o.GetType().GetRuntimeProperties()) {
                var name = data.Name;
                var value = data.GetValue(o, null);
            ...
            return JsonConvert.SerializeObject(logdata, kSerializationSettings);
        }
